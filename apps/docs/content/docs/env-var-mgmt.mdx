...
description: "This document explains the environment variable model and the reasoning behind it. For concise syntax reference, see Configuration and Services."
---
This document explains the environment variable model and the reasoning behind
it. For concise syntax reference, see [Configuration](/docs/configuration) and
