---
title: "Profiles"
description: "Profiles are Zapper's primary runtime selection model. They combine env file selection, service selection, and stack isolation into one named configuration."
---
