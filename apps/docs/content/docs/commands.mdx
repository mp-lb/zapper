---
title: "Commands"
description: "Reference for every Zapper CLI command, generated from the commander command tree."
---
...
matches `zap <command> --help`. See [Tasks](/docs/tasks) for task configuration,
[Configuration](/docs/configuration) for `zap.yaml` fields, and
[Command Output](/docs/output) for the JSON/result contract.
...
For the command result and rendering contract, see [Command Output](/docs/output).
