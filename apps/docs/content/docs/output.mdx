...
description: "This document describes Zapper's internal command output contract: the structured result a command produces after interpreting user input and running core logic"
---
